document.addEventListener('DOMContentLoaded', () => {
  ...
  const cvFileInput = document.getElementById('cv-resume');      // Changed to unique id
  const cvFileNameSpan = document.getElementById('cv-file-name'); // Changed to unique id
