...
(function () {
    const card3 = document.querySelector('.intro-card-wrapper:nth-child(3)');
    if (!card3) return;
    ...
    card3.addEventListener('mouseenter', () => {
      ...
      card3.classList.add('is-hovered');
    });

    card3.addEventListener('mouseleave', () => {
      // small delay avoids thrash when the content shifts under the cursor
      leaveTimer = setTimeout(() => card3.classList.remove('is-hovered'), 80);
    });
  })();
